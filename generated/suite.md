...
| `hermes-lcm` | Hermes LCM | context_extension | implementation | experimental | `kvnloo/hermes-lcm` |
...
| `z0evals` | z0evals | publication_evidence | frozen_evidence | active | `kvnloo/z0evals` |
